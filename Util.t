...
my $choices = {
	Kai => {
		...
		qq[<choice idref="sect164">If you do not possess an Effigy but do possess the Sommerswerd, <link-text>turn to 164</link-text>.</choice>]
		    => undef,
		qq[<choice idref="sect156">If you have the Kai Discipline of Animal Kinship or if you have reached the Kai rank of Aspirant (you are skilled in six Kai Disciplines) or above, <link-text>turn to 156</link-text>.</choice>]
		    => qq["AnK or 2+"],
	},
	Magnakai => {
		...
		qq[<choice idref="sect297">If you do not have the power of Psi-surge, or if you have not yet reached the rank of Primate, <link-text>turn to 297</link-text>.</choice>]
		    => undef,
		qq[<choice idref="sect257">If you have yet to reach the rank of Primate, or you do not possess the skill of Psi-surge, <link-text>turn to 257</link-text>.</choice>]
		    => undef,
		qq[<choice idref="sect325">If you do not possess this skill, or have yet to reach the Magnakai rank of Tutelary, <link-text>turn to 325</link-text>.</choice>]
		    => undef,
	},
	Grandmaster => {
		...
		qq[<choice idref="sect146">If you possess Kai-alchemy (and wish to use it), but have yet to attain the rank of Kai Grand Crown, <link-text>turn to 146</link-text>.</choice>]
		    => qq["Kal"],
		qq[<choice idref="sect156">If you do not possess a Bow, or this skill, or if you have yet to attain the rank of Sun Lord, <link-text>turn to 156</link-text>.</choice>]
		    => undef,
		qq[<choice idref="sect187">If your current level of Kai rank is Sun Knight or lower, <link-text>turn to 187</link-text>.</choice>]
		    => qq["15-"],
		qq[<choice idref="sect82">If your current level of Kai rank is Grand Crown or higher, <link-text>turn to 82</link-text>.</choice>]
		    => qq["19+"],
		qq[<choice idref="sect219">If your current level of Kai rank is between Grand Thane and Sun Lord, <link-text>turn to 219</link-text>.</choice>]
		    => qq["18-16"],
		qq[<choice idref="sect338">If you do not have a Bow, do not possess Kai-alchemy, or have yet to reach the required Kai rank, <link-text>turn instead to 338</link-text>.</choice>]
		    => undef,
		qq[<choice idref="sect114">If you do not have a Bow, the Discipline of Grand Nexus, or if you have yet to attain this higher level of Kai Mastery, <link-text>turn to 114</link-text>.</choice>]
		    => undef,
		qq[ <choice idref="sect306">If you do not possess Assimilance, have yet to attain the required level of Kai rank, or do not possess either Special Item (or have chosen not to use it), <link-text>turn instead to 306</link-text>.</choice>]
		    => undef,
		qq[<choice idref="sect111">If you have not yet attained this level of Kai rank but you do possess a Rope, <link-text>turn to 111</link-text>.</choice>]
		    => undef,
		qq[<choice idref="sect30">If you have yet to attain this level of Kai rank and you do not possess a Rope, <link-text>turn instead to 30</link-text>.</choice>]
		    => undef,
	},
};
